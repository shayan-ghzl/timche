let productCounterInit = (function productCounter() {
    ...
    document.querySelectorAll(".so_focus_input").forEach((element) => {
    ...
    document.querySelectorAll(".so_add_basket").forEach((element) => {
        element.addEventListener("click", (e) => {
            e.preventDefault();
    ...
    document.querySelectorAll("input.so_input").forEach((element) => {
    ...
    document.querySelectorAll("button.so_add_btn").forEach((element) => {
        element.addEventListener("click", (e) => {
    ...
    document.querySelectorAll("button.so_remove_btn").forEach((element) => {
        element.addEventListener("click", (e) => {
...
let allInput = document.querySelectorAll(".so_item_counter  input");
